...
public class ErrorType {
    public enum ErrTypes{
        ...
        BASIC_REQUIRED_FIELDS_EMPTY, EXPERIENCE_REQUIRED_FIELDS_EMPTY, SKILLS_REQUIRED_FIELDS_EMPTY, COURSES_REQUIRED_FIELDS_EMPTY, WRONG_DATE_FORMAT, EDUCATION_REQUIRED_FIELDS_EMPTY
