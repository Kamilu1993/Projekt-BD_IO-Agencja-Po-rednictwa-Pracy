...
public class CVForm extends JFrame{
    ...
    public void setPhoto(byte[] array){
        ...
        PhotoLabel.setIcon(new ImageIcon(PhotoArray));
        PhotoLabel.repaint();
    ...
    public CVForm(){
        ...
        setContentPane(new JLabel(new ImageIcon(Login.class.getResource("Images/addCV_bg.jpg")))); // pobranie tła
        ...
        BtAddEducation.setIcon(new ImageIcon(Login.class.getResource("Images/addIcon.png")));
        ...
        BtAddWork.setIcon(new ImageIcon(Login.class.getResource("Images/addIcon.png")));
        ...
        BtAddSkill.setIcon(new ImageIcon(Login.class.getResource("Images/addIcon.png")));
        ...
        BtAddCourses.setIcon(new ImageIcon(Login.class.getResource("Images/addIcon.png")));
        ...
        BtAddInterest.setIcon(new ImageIcon(Login.class.getResource("Images/addIcon.png")));
